            ...
            <CardContent>
              <ol className="space-y-3 text-sm text-white text-muted-foreground">
                <li className="flex gap-3">
                  ...
                  <span className="text-muted-foreground">Go to <a href="https://leetcode.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">leetcode.com</a> and make sure you&apos;re logged in</span>
                </li>
                <li className="flex gap-3">
                  ...
                  <span className="text-muted-foreground">Open DevTools: <kbd className="bg-gray-600 px-1.5 py-0.5 rounded text-xs text-white">F12</kbd> or <kbd className="bg-gray-600 px-1.5 py-0.5 rounded text-xs text-white">Cmd+Option+I</kbd></span>
                </li>
                <li className="flex gap-3">
                  ...
                  <span className="text-muted-foreground"> Go to <strong>Application</strong> → <strong>Cookies</strong> → <strong>https://leetcode.com</strong></span>
                </li>
                <li className="flex gap-3">
                  ...
                  <span className="text-muted-foreground">Copy <code className="bg-gray-600 px-1.5 py-0.5 rounded text-xs text-white">LEETCODE_SESSION</code> value</span>
                </li>
                <li className="flex gap-3">
                  ...
                  <span className="text-muted-foreground">Copy <code className="bg-gray-600 px-1.5 py-0.5 rounded text-xs text-white">csrftoken</code> value</span>
                </li>
              </ol>
            </CardContent>
          </Card>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="text-primary font-bpmf-huninn"
                  required
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="flex min-h-[80px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 text-primary font-bpmf-huninn"
